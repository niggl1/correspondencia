...
export const emailBaseTemplate = (content: string) => `
<!DOCTYPE html>
<html lang="pt-BR">
<head>
  <meta charset="UTF-8">
    ...
    <tr>
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          ...
          <!-- Header Verde -->
          <tr>
            <td style="background: linear-gradient(135deg, #057321 0%, #034d17 100%); padding: 40px 30px; text-align: center;">
...
// Botão verde padrão
export const buttonGreen = (text: string, url: string) => `
  <table cellpadding="0" cellspacing="0" style="margin: 30px 0;">
    <tr>
      <td align="center" style="background-color: #057321; border-radius: 8px; padding: 14px 32px;">
        <a href="${url}" style="color: #ffffff; text-decoration: none; font-weight: bold; font-size: 16px; display: inline-block;">
          ${text}
        </a>
      </td>
    </tr>
...
export const infoBoxGreen = (content: string) => `
...
export const warningBox = (content: string) => `
