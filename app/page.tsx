...
export default function LoginPage() {
  ...
  const abrirWhatsApp = () => {
    window.open('https://wa.me/5581999618516', '_blank')
  }
  ...
  return (
    // ✅ CORREÇÃO DE LAYOUT: 'min-h-screen' com 'py-12' permite rolagem se a tela for pequena
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-green-100 flex justify-center py-12 px-4 sm:px-6 lg:px-8 overflow-y-auto">
      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 space-y-6 my-auto">
        ...
        <form onSubmit={entrar} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full bg-primary-500 text-white py-3 rounded-lg font-medium hover:bg-primary-600 disabled:opacity-50 transition"
            disabled={loading}
          >
        ...
        {/* ✅ ÁREA DE BOTÕES SECUNDÁRIOS (Corrigido agrupamento) */}
        <div className="flex flex-col gap-3">
            ...
            {/* ✅ BOTÃO SUPORTE WHATSAPP - Corrigido e Garantido */}
            <button
            onClick={abrirWhatsApp}
            type="button"
            className="w-full flex items-center justify-center gap-2 bg-white text-[#25D366] border-2 border-[#25D366] py-3 rounded-lg font-bold hover:bg-green-50 transition"
            >
